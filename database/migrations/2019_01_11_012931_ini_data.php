...
class IniData extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('data_tbl_ini', function (Blueprint $table) {
            $table->increments('id');
...
/////////////////////////////////////////////////////////////////
            $table->date('tgl_create_pib')->nullable();
////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////
            $table->text('ppjkname')->nullable();
            $table->text('csopraname')->nullable();
            $table->text('trackname')->nullable();
            $table->text('sssss')->nullable();
            $table->text('nosuratjl')->nullable();
            $table->text('tgldelevery')->nullable();
            $table->text('tglunloading')->nullable();
            $table->text('tglretrnemptcontainer')->nullable();
            $table->text('namasupir')->nullable();
            $table->text('notelephone')->nullable();
            $table->text('jmluangjln')->nullable();
            $table->timestamps();
        });
    }
    /**
    ...
    {
        Schema::dropIfExists('data_tbl_ini');
